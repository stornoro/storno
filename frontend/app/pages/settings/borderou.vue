...
const { t: $t } = useI18n()
useHead({ title: $t('borderou.title') })
...
onMounted(() => {
  store.filters.sourceType = 'borderou'
...
<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-xl font-semibold">{{ $t('borderou.title') }}</h1>
      </div>
      <UButton
        :label="$t('borderou.importButton')"
