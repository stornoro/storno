...
const { t: $t } = useI18n()
useHead({ title: $t('marketplace.title') })
...
onMounted(() => {
  store.filters.sourceType = 'marketplace'
  ...
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-sm text-(--ui-text-muted) mt-1">{{ $t('marketplace.description') }}</p>
      </div>
      <UButton
        :label="$t('marketplace.importButton')"
