...
export const WIDGET_CATALOG: CatalogWidget[] = [
  ...
  { id: 'expiries-card', name_key: 'dashboard.widgets.expiries.name', description_key: 'dashboard.widgets.expiries.description', size: 'md', category: 'activity' },
]
...
const DEFAULT_CONFIG: WidgetConfig[] = [
  ...
  { id: 'expiries-card', position: 17, visible: false },
]
