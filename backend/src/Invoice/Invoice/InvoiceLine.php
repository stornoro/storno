...
class InvoiceLine implements XmlSerializable, XmlDeserializable
{
    ...
    /**
     * @param Quantity $invoicedQuantity
     * @return InvoiceLine
     */
     ...
     * @return InvoiceLine
     */
    public function setLineExtensionAmount(Amount $lineExtensionAmount): InvoiceLine
    {
    ...
    public function xmlSerialize(Writer $writer): void
    {
        ...
        $writer->write([
            [
                ...
                'value' => number_format($this->getInvoicedQuantity()->getValue(), 2, '.', ''),
                'attributes' => [
                    'unitCode' => $this->getInvoicedQuantity()->getUnitCode()
                ]
            ],
            [
