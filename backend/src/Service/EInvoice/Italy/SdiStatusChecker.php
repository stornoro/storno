...
#[AutoconfigureTag('app.einvoice_status_checker', ['provider' => 'sdi'])]
final class SdiStatusChecker implements EInvoiceStatusCheckerInterface
{
    ...
    public function check(EInvoiceSubmission $submission, CheckEInvoiceStatusMessage $message): void
    {
        ...
        try {
            ...
            $this->logger->error('SdiStatusChecker: Status check failed.', [
                'submissionId' => $message->submissionId,
                'error' => $e->getMessage(),
            ]);
