...
#[AutoconfigureTag('app.einvoice_status_checker', ['provider' => 'ksef'])]
final class KsefStatusChecker implements EInvoiceStatusCheckerInterface
{
    ...
    public function check(EInvoiceSubmission $submission, CheckEInvoiceStatusMessage $message): void
    {
        ...
        try {
            ...
            $this->logger->error('KsefStatusChecker: Status check failed.', [
                'submissionId' => $message->submissionId,
                'error' => $e->getMessage(),
            ]);
